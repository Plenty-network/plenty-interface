      ...
      if (WALLET_RESP.success) {
        ...
        let tokenAmount =
          ...
          Math.pow(
            ...
            CONFIG.POOLS[connectedNetwork][poolIdentifier][isActive === true ? 'active' : 'inactive'][position].TOKEN_DECIMAL
          );
        let batch = null;
        if (
          //CONFIG.CONTRACT[connectedNetwork].POOLS[poolIdentifier].TYPE === 'FA1.2'
          CONFIG.POOLS[connectedNetwork][poolIdentifier][isActive === true ? 'active' : 'inactive'][position].TYPE === 'FA1.2'
        ) {
              ...
              tokenContractInstance.methods.update_operators([
                {
                  add_operator: {
                    ...
                    token_id:
                      ...
                      CONFIG.POOLS[connectedNetwork][poolIdentifier][isActive === true ? 'active' : 'inactive'][position].TOKEN_ID
                  },
                },
              ])
            )
