...
export const getPoolsData = (isActive) => {
    return dispatch => {
        if(isActive)
        {
            ...
            poolsApis.getPoolsData(isActive)
                .then(response => {
...
export const stakeOnPool = (amount, poolIdentifier , isActive, position) => {
    return dispatch => {
        ...
        poolsApis.stake(amount, poolIdentifier , isActive, position)
            .then(response => {
...
export const unstakeOnPool = (amount, mapKey, poolIdentifier, isActive, position) => {
    return dispatch => {
        dispatch(initiateUnstakingOperationOnPool())
        poolsApis.unstake(amount, mapKey, poolIdentifier, isActive, position)
            .then(response => {
...
export const harvestOnPool = (poolIdentifier, isActive, position) => {
    return dispatch => {
        ...
        poolsApis.harvest(poolIdentifier, isActive, position)
            .then(response => {
