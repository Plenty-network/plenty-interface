...
export default function VoteModalResultscopy() {
  ...
  <div className='vote_votingBox__3kXMW vote_textColor__35snG vote_borderChange__1W7wT vote_removeMargin__1TTvs'>
    <div className='vote_votingBoxBg__28C9S vote_selectedVotingBoxBg__1hLKA' style={{width: '84.87%'}} /><input className=' undefined' id='select-accept' type='radio' defaultValue='Accept' defaultChecked /><label className='ml-4 vote_selectItem__1iG5V vote_selectedVotingLabel__2OImu' htmlFor='select-accept'>Accepted</label><span className='vote_textColor__35snG vote_percentageResults__3Sjwa vote_selectedVotingText__1yaw-'>84.87%</span>
  </div>
  <div className='vote_totalStats__hOEcO'><span>101 votes</span><span className='mx-2  vote_dot__1ze-3' /><span>2425911.36 xplenty</span></div>
  <div className='vote_votingBox__3kXMW vote_textColor__35snG vote_borderChange__1W7wT vote_removeMargin__1TTvs'>
    <div className='vote_votingBoxBg__28C9S vote_defaultVotingBoxBg__1hPpZ' style={{width: '10.08%%'}} /><input className=' undefined' id='select-reject' type='radio' defaultValue='Reject' defaultChecked /><label className='ml-4 vote_selectItem__1iG5V vote_defaultVotingText__3Uyx9' htmlFor='select-reject'>Rejected</label><span className='vote_textColor__35snG vote_percentageResults__3Sjwa vote_defaultVotingText__3Uyx9'>10.08%%</span>
  </div>
  <div className='vote_totalStats__hOEcO'><span>12 votes </span><span className='mx-2  vote_dot__1ze-3' /><span>302360.35 xplenty</span></div>
  <div className='vote_votingBox__3kXMW vote_textColor__35snG vote_borderChange__1W7wT vote_removeMargin__1TTvs'>
    <div className='vote_votingBoxBg__28C9S vote_defaultVotingBoxBg__1hPpZ' style={{width: '5.04%'}} /><input className='undefined' id='select-abstained' type='radio' defaultValue='Abstain' defaultChecked /><label className='ml-4 vote_selectItem__1iG5V vote_defaultVotingText__3Uyx9' htmlFor='select-abstained'>Abstained</label><span className='vote_textColor__35snG vote_percentageResults__3Sjwa vote_defaultVotingText__3Uyx9'>5.04%</span>
  </div>
  <div className='vote_totalStats__hOEcO'><span>13893.88 xplenty</span></div><span className='mt-5  vote_totalStats__hOEcO'><svg width={17} height={18} viewBox='0 0 17 18' fill='none' xmlns='http://www.w3.org/2000/svg' className='mr-2 mb-1'>
    ...
    </svg>119 total number of votes.</span>
  <div className='mt-3 vote_resultsDates__1wS7E'><span className='vote_startEndLabel__2qZBj'>Start Date</span><span className='vote_startEndDate__3SoM4'>April 18, 2022</span></div>
  <div className='mt-3 vote_resultsDates__1wS7E'>
    <div className='vote_startEndLabel__2qZBj'>End date</div>
    <div className='vote_startEndDate__3SoM4'><span>April 25, 2022</span></div>
  </div>
</div>
</div>
</div>
