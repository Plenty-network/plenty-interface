    ...
    if (type === 'FA1.2') {
      if (icon === 'WRAP') {
        ...
        if (bigmapVal) {
          ...
          if (bigmapValData.hasOwnProperty('prim') && bigmapValData.prim === 'Pair') {
...
const getuDEFIPrice = async () => {
  try {
    ...
    let uDEFIOracleUrl = `${rpcNode}chains/main/blocks/head/context/contracts/KT1UuqJiGQgfNrTK5tuR1wdYi5jJ3hnxSA55/storage`;
